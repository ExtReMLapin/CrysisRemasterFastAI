Chickens = {
  ...
  MapVisMask = 0,
	...
	{
		"Sounds/physics:animals:chicken_idle",   -- idle 
		"Sounds/physics:animals:chicken_scared",     -- scared
		"Sounds/physics:animals:chicken_die",    -- die
		"Sounds/physics:animals:chicken_pickup",   -- pickup
		"Sounds/physics:animals:chicken_throw",   -- throw
	},
	Animations = 
	{
		"walk_loop",   -- walking
