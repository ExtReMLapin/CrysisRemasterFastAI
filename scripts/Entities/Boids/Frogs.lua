Frogs = {
  type = "Boids",
	...
	{
                          "Sounds/physics:animals:frog_idle",   -- idle
                          "Sounds/physics:animals:frog_idle",  -- scared
                          "Sounds/physics:animals:frog_die",    -- die
                          "Sounds/physics:animals:frog_die",  -- pickup
                          "Sounds/physics:animals:frog_die",  -- throw
	},
	Animations = 
	{
