...
Alien_x = {
	...
	foreignCollisionDamageMult = 0.0,	
	selfCollisionDamageMult = 0.01,		
	collisionKillVelocity = 40.0,
	...
	Properties = {
	  bExactPos = 0,
		...
		Perception =
		{
			...
			stanceScale = 0.5,
			sightEnvScaleNormal = 0.5,
			sightEnvScaleAlarmed = 0.9,
...
--	g_gameRules:ClientViewShake(pos,nil,0,10,40,0.25,0.09);
--	
--	self:RemoveActor();
end
