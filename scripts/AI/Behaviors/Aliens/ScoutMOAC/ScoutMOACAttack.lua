...
AIBehaviour.ScoutMOACAttack = {
	...
	Constructor = function ( self, entity, sender, data )
		...
		entity.AI.lastStrafingPitch = -17.0;
...
--		System.Log("AIPARAM_STRAFINGPITCH "..entity.AI.lastStrafingPitch );
		...
		AI.PushGoal("ScoutMOACFire2","+timeout",1,180.0);
		...
		AI.PushGoal("ScoutMOACFire3","+timeout",1,180.0);
		...
		AI.PushGoal("ScoutMOACFire4","+timeout",1,180.0);
		...
		AI.PushGoal("ScoutMOACLookAt","timeout",1,3.0);
		AI.PushGoal("ScoutMOACLookAt","signal",0,1,"SCOUTMOACATTACK_BASICAPPROACH",SIGNALFILTER_SENDER);

		AI.CreateGoalPipe("ScoutMOAC");
		AI.PushGoal("ScoutMOAC","firecmd",0,0);
		AI.PushGoal("ScoutMOAC","+lookat",0,-500,0);
		AI.PushGoal("ScoutMOAC","timeout",1,3.0);
		...
		AI.PushGoal("ScoutMOACFollowPath","timeout",1,6.0);
		...
		AI.PushGoal("ScoutMOACFollowPathRvs","timeout",1,6.0);
...
--				if ( rand > 150 and entity.AI.CurrentHook ~= fSCOUTMOACATTACK_SHORTDUSH ) then
...
--					return;
	...
	SCOUTMOACATTACK_CIRCLING = function ( self, entity )
		...
		if ( target and AIBehaviour.ScoutMOACDefault:scoutCheckHostile( entity, target )==true ) then
			...
			entity.AI.bLock = entity.AI.bLock + ( 15.0 * 3.1416 / 180.0 );
			...
			CopyVector( entity.AI.vTargetRsv, target:GetPos() );
			if ( vMyPos.z > entity.AI.vTargetRsv.z + 15.0 ) then
				vVelRot.z = vVelRot.z - 10.0;
			end
	...
	SCOUTMOACATTACK_SHORTDUSH_START = function( self, entity )
		...
		if ( target and AIBehaviour.ScoutMOACDefault:scoutCheckHostile( entity, target )==true ) then
			...
			--entity.AI.vDirectionRsv.z = 0;
			entity.AI.vDirectionRsv.z = entity.AI.vDirectionRsv.z + 2.0;
			NormalizeVector( entity.AI.vDirectionRsv );
