...
AIBehaviour.ScoutMOACDefault = {
	...
	ACT_SHOOTAT = function( self, entity, sender, data )
		...
		AI.CreateGoalPipe("action_s_shoot_at");
		AI.PushGoal("action_s_shoot_at", "locate", 0, "refpoint");
		AI.PushGoal("action_s_shoot_at", "+lookat",0,0,0,true,1);		
		AI.PushGoal("action_s_shoot_at", "+firecmd",0,FIREMODE_FORCED,AILASTOPRES_USE);
		AI.SetRefPointPosition( entity.id, data.point );
		entity:InsertSubpipe( AIGOALPIPE_SAMEPRIORITY, "action_s_shoot_at" );
