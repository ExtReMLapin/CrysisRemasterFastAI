...
--	end,
	...
	ACT_SHOOTAT = function( self, entity, sender, data )
		...
		AI.CreateGoalPipe("action_h_shoot_at");
		AI.PushGoal("action_h_shoot_at", "firecmd", 0, FIREMODE_OFF);
		AI.PushGoal("action_h_shoot_at", "locate", 0, "refpoint");
		AI.PushGoal("action_h_shoot_at", "lookat", 0, 0, 0, true, 1);
		AI.PushGoal("action_h_shoot_at", "firecmd", 0, FIREMODE_FORCED, AILASTOPRES_USE);
		AI.PushGoal("action_h_shoot_at", "timeout", 1, 8.5); -- data.fValue);
		AI.PushGoal("action_h_shoot_at", "firecmd", 0, FIREMODE_OFF);
		AI.PushGoal("action_h_shoot_at", "lookat", 0, -500, 0);
		AI.PushGoal("action_h_shoot_at", "timeout", 1, 5);
		
		AI.SetRefPointPosition( entity.id, data.point );
		entity:InsertSubpipe( AIGOALPIPE_SAMEPRIORITY, "action_h_shoot_at", nil, data.iValue );
