...
AIBehaviour.InVehicleControlledGunner = {
	...
	Constructor = function( self, entity, sender, data )
		...
		if ( data==nil ) then
			...
			if ( vehicleId ) then
				local attackRange = AI.GetParameter(vehicleId, AIPARAM_ATTACKRANGE);
				AI.ChangeParameter( entity.id, AIPARAM_ATTACKRANGE, attackRange );
				AI.ChangeParameter( entity.id, AIPARAM_SIGHTRANGE, attackRange );
			end
