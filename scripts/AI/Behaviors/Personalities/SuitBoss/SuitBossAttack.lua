...
AIBehaviour.SuitBossAttack = {
	...
	ToPhase3 = 25,	-- phase 3 - berserk		martinsh: This phase has been disabled because it doesn't play well

	Constructor = function (self, entity)
	
		AIBehaviour.SuitAttack:Constructor( entity );
	...
	COVER_NORMALATTACK = function (self, entity, sender)
		...
		if( anchorName ) then
			...
			if( pos and dir ) then
				...
				AI.SetRefPointDirection( entity.id, dir );
