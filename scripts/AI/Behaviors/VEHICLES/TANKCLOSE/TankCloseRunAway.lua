...
AIBehaviour.TankCloseRunAway = {
	...
	ACT_DUMMY = function( self, entity, sender, data )
		...
		self:TANKCLOSE_RUNAWAY( entity, self, data );

	end,

	---------------------------------------------------------------------------------------------------------------------------------------
	TANKCLOSE_RUNAWAY = function( self, entity, sender, data )
	...
	---------------------------------------------------------------------------------------------------------------------------------------
	TANKCLOSE_RUNAWAY1 = function( self, entity, sender, data )
	...
	---------------------------------------------------------------------------------------------------------------------------------------
	TANKCLOSE_RUNAWAY2 = function( self, entity, sender, data )
