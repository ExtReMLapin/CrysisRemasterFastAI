...
function PipeManager:OnInitCover2()
	...
	AI.BeginGoalPipe("cv_investigate_threat_cloaked");
		AI.PushGoal("run",0,0);
		AI.PushGoal("bodypos",1,BODYPOS_STEALTH,1);	
...
--		AI.PushGoal("firecmd",0,FIREMODE_AIM);
	...
	AI.BeginGoalPipe("cv_backoff_from_explosion");
		...
		AI.PushGoal("locate",0,"refpoint");
		AI.PushGoal("+approach",1,-11,AILASTOPRES_USE+AI_REQUEST_PARTIAL_PATH,15,"",4, true);
		AI.PushGoal("run",0,0);
	...
	AI.BeginGoalPipe("cv_backoff_from_explosion_short");
		...
		AI.PushGoal("strafe",0,2,2);
		AI.PushGoal("locate",0,"refpoint");
		AI.PushGoal("+approach",1,-7,AILASTOPRES_USE+AI_REQUEST_PARTIAL_PATH,15,"",2, true);
		AI.PushGoal("run",0,0);
		AI.PushGoal("signal",1,1,"END_BACKOFF",SIGNALFILTER_SENDER);
	AI.EndGoalPipe();
...
--		AI.PushGoal("bodypos",1,BODYPOS_STEALTH);
	...
	AI.BeginGoalPipe("sb_backoff");
		AI.PushGoal("firecmd",0,1);
		AI.PushGoal("run",0,1);
		AI.PushGoal("branch", 1, "CAN_SEE", IF_SEES_TARGET);
		AI.PushGoal("branch", 1, "CANT_SEE", BRANCH_ALWAYS);
		AI.PushLabel("CAN_SEE");
			AI.PushGoal("strafe",0,15,15);
			AI.PushGoal("hide",1,15,HM_NEAREST_BACKWARDS,0,0);
			AI.PushGoal("branch", 1, "END", BRANCH_ALWAYS);
		
		AI.PushLabel("CANT_SEE");
			AI.PushGoal("firecmd",0,FIREMODE_PANIC_SPREAD);
			AI.PushGoal("branch", 1, "END", BRANCH_ALWAYS);
...
--			AI.PushLabel("END_STANCE");
	...
	---------------------------------------------
	-- boss - walk up to target, keep shooting
	AI.BeginGoalPipe("sb_press");
		AI.PushGoal("firecmd", 0, FIREMODE_BURST);
		AI.PushGoal("run", 0, 2);
		AI.PushGoal("bodypos", 0, BODYPOS_STAND);
		AI.PushGoal("stick",0,3,0,STICK_BREAK, -1);
		AI.PushGoal("branch", 1, "CAN_SEE", BRANCH_ALWAYS); -- Always do this once, even if we can't see the target	
		AI.PushLabel("STICK_LOOP");
			AI.PushGoal("branch", 1, "CAN_SEE", IF_SEES_TARGET);
			AI.PushGoal("branch", 1, "STICK_END", BRANCH_ALWAYS); -- Target can't be seen, so end stick.	
			AI.PushLabel("CAN_SEE");		
...
--			AI.PushGoal("ignoreall",0,0);
	...
	---------------------------------------------
	AI.BeginGoalPipe("sn_target_disappear_reaction");
		AI.PushGoal("signal",1,1,"confused",SIGNALID_READIBILITY,115);
		...
		AI.PushGoal("locate", 0,"refpoint");
		AI.PushGoal("firecmd",0, FIREMODE_PANIC_SPREAD, 1); -- shoot last operation result: located refpoint
		AI.PushGoal("timeout",1,1,3);
		AI.PushGoal("firecmd",0,0);
		AI.PushGoal("bodypos",1,BODYPOS_STAND);
		AI.PushGoal("run",0,2,1,10);
...
--		AI.PushGoal("bodypos",1,BODYPOS_STAND, 1);
	...
	AI.EndGoalPipe();
		...
		---------------------------------------------
	AI.BeginGoalPipe("cv_seek_target_cloaked");
...
--		AI.PushLabel("HIDE_OK");
	...
	AI.BeginGoalPipe("su_cqb");
		...
		AI.PushGoal("bodypos",0,BODYPOS_STAND,1);
		AI.PushGoal("run",0,1);
		AI.PushGoal("firecmd",0,FIREMODE_KILL);
...
--		AI.PushGoal("timeout",1,1,2);
	...
	AI.BeginGoalPipe("su_idle");
		...
		AI.PushGoal("run",0,0);
		AI.PushGoal("firecmd",0,FIREMODE_AIM);
		AI.PushGoal("lookaround",1,120,4,6,10,AI_BREAK_ON_LIVE_TARGET);
	AI.EndGoalPipe();
...
--			AI.PushGoal("lookaround",0,30,3,100,100,AI_BREAK_ON_LIVE_TARGET);
		...
		AI.PushGoal("signal",0,1,"INVESTIGATE_READABILITY",0);
		AI.PushGoal("timeout",1,1,3);
		AI.PushGoal("signal",0,1,"SUIT_THREATENED",0);
	AI.EndGoalPipe();
	
	---------------------------------------------
	AI.BeginGoalPipe("su_takecover");
		AI.PushGoal("strafe",0,100,100);
		AI.PushGoal("bodypos",0,BODYPOS_CROUCH);
		AI.PushGoal("run",0,0);
		AI.PushGoal("firecmd",0,0);
	...
	---------------------------------------------
	AI.BeginGoalPipe("su_attack_adaptive");
		AI.PushGoal("firecmd",0,FIREMODE_BURST_DRAWFIRE);
		AI.PushGoal("timeout",1,0.3);
		AI.PushGoal("strafe",0,100,100);
		AI.PushGoal("bodypos",0,BODYPOS_STAND,1);
		AI.PushGoal("run",0,0);
		AI.PushGoal("firecmd",0,FIREMODE_BURST_DRAWFIRE);
		AI.PushGoal("branch", 1, "END_THING", IF_CAN_SHOOT_TARGET, 123456.7);
			AI.PushGoal("locate", 0,"probtarget_in_territory");
			AI.PushGoal("+approach",1,-15,AILASTOPRES_USE,3.0);
		AI.PushLabel("END_THING");
		AI.PushGoal("signal",0,1,"COVER_NORMALATTACK",0);
	AI.EndGoalPipe();
	...
	---------------------------------------------
	AI.BeginGoalPipe("su_sniper_shoot");
		AI.PushGoal("signal",0,1,"SUIT_ARMOR_MODE",0);
		AI.PushGoal("firecmd",0,FIREMODE_BURST);
		AI.PushGoal("strafe",0,100,100);
		AI.PushGoal("bodypos",0,BODYPOS_STAND,1);
		...
		AI.PushGoal("timeout",1,2,4);
		AI.PushGoal("signal",0,1,"COVER_NORMALATTACK",0);
	AI.EndGoalPipe();
	
	---------------------------------------------
	AI.BeginGoalPipe("su_sniper_shoot_lethal");
		AI.PushGoal("signal",0,1,"SUIT_ARMOR_MODE",0);
		AI.PushGoal("firecmd",0,FIREMODE_KILL);
		AI.PushGoal("strafe",0,100,100);
		AI.PushGoal("bodypos",0,BODYPOS_STAND,1);
	...
	---------------------------------------------
	AI.BeginGoalPipe("su_sniper_observe");
		AI.PushGoal("locate", 0, "refpoint");	
	...
	---------------------------------------------
	AI.BeginGoalPipe("su_sniper_relocate_backoff");
		AI.PushGoal("signal",0,1,"SUIT_CLOAK_MODE",0);
		AI.PushGoal("firecmd",0,FIREMODE_OFF);
		AI.PushGoal("strafe",0,1,1);
		AI.PushGoal("bodypos",0,BODYPOS_STAND,1);
		AI.PushGoal("run",0,2);		
		AI.PushGoal("backoff",1,45,7,AI_MOVE_BACKWARD+AI_MOVE_LEFT+AI_MOVE_RIGHT);
		AI.PushGoal("locate",0,"probtarget");
		AI.PushGoal("+seekcover", 1, COVER_HIDE, 5.0, 3, 1);
		--AI.PushGoal("timeout",1,4,9);
		AI.PushGoal("signal",0,1,"COVER_NORMALATTACK",0);
	AI.EndGoalPipe();
	
	---------------------------------------------
	AI.BeginGoalPipe("su_sniper_relocate");
		AI.PushGoal("signal",0,1,"SUIT_CLOAK_MODE",0);
		AI.PushGoal("firecmd",0,FIREMODE_OFF);
		AI.PushGoal("strafe",0,1,1);
		AI.PushGoal("bodypos",0,BODYPOS_STAND,1);
		AI.PushGoal("run",0,2);
		AI.PushGoal("locate",0,"probtarget");
		AI.PushGoal("+seekcover", 1, COVER_HIDE, 45.0, 3, 1);
		AI.PushGoal("signal",0,1,"COVER_NORMALATTACK",0);
	AI.EndGoalPipe();
	
	---------------------------------------------
	AI.BeginGoalPipe("su_sniper_relocate_advance");
		AI.PushGoal("signal",0,1,"SUIT_CLOAK_MODE",0);
		AI.PushGoal("firecmd",0,FIREMODE_OFF);
		AI.PushGoal("strafe",0,1,1);
		AI.PushGoal("bodypos",0,BODYPOS_STAND,1);
		AI.PushGoal("run",0,2);
		AI.PushGoal("locate",0,"probtarget");
		AI.PushGoal("+approach", 1, 55, AILASTOPRES_USE, 3.0);
		AI.PushGoal("+seekcover", 1, COVER_HIDE, 2.0, 3, 1);
		AI.PushGoal("signal",0,1,"COVER_NORMALATTACK",0);
	AI.EndGoalPipe();
	...
	---------------------------------------------
	AI.BeginGoalPipe("su_advance_cloaked");
		...
		AI.PushGoal("bodypos",1,BODYPOS_STAND, 1);
			...
			AI.PushGoal("branch", 1, "INDOOR", IF_NAV_WAYPOINT_HUMAN);
				AI.PushGoal("locate",0,"refpoint");
				AI.PushGoal("+approach",1,3,AILASTOPRES_USE+AI_REQUEST_PARTIAL_PATH+AI_USE_TIME,15,"",8);
				AI.PushGoal( "branch", 1, "HIDE_OK", BRANCH_ALWAYS);
			AI.PushLabel("INDOOR");
				AI.PushGoal("locate",0,"refpoint");
				AI.PushGoal("+approach",1,-6,AILASTOPRES_USE+AI_REQUEST_PARTIAL_PATH,15,"",3);
