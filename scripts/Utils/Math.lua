...
function LengthSqCompVector(x, y, z)
	return x * x + y * y + z * z;
end

function LengthCompVector(x, y, z)
	return math.sqrt(LengthSqCompVector(x, y, z));
end
...
function NormalizeCompVector(x, y, z)
...
function FastScaleCompVector(x, y, z, s)
	return x * s, y * s, z * s;
end
